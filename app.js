    ...
    if (cs) {
        ...
        res.render('export-page',{
            ...
            profs : {
                ...
                arcana: Math.floor((cs.getIntelligenceSync() - 10) / 2),
                athletics: Math.floor((cs.getStrSync() - 10) / 2),
                deception: Math.floor((cs.getChaSync() - 10) / 2),
                history: Math.floor((cs.getIntelligenceSync() - 10) / 2),
                insight: Math.floor((cs.getWisSync() - 10) / 2),
                intimidation: Math.floor((cs.getIntelligenceSync() - 10) / 2),
                investigation: Math.floor((cs.getIntelligenceSync() - 10) / 2),
                medicine: Math.floor((cs.getWisSync() - 10) / 2),
                nature: Math.floor((cs.getIntelligenceSync() - 10) / 2),
                perception: Math.floor((cs.getWisSync() - 10) / 2),
                performance: Math.floor((cs.getChaSync() - 10) / 2),
                psersuasion: Math.floor((cs.getIntelligenceSync() - 10) / 2),
                religion: Math.floor((cs.getIntelligenceSync() - 10) / 2),
